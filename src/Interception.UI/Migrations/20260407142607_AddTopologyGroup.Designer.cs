...
namespace Interception.UI.Migrations
{
    ...
    [Migration("20260407142607_AddTopologyGroup")]
    partial class AddTopologyGroup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Interception.UI.Domain.TopologySnapshotBridge", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.TopologySnapshotBridgeAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.TopologySnapshotGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.TopologySnapshotGroupAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.TopologySnapshotGroupFrequency", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.TopologySnapshotGroupMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.TopologySnapshotBridge", b =>
                {
                    b.HasOne("Interception.UI.Domain.TopologySnapshotGroup", "Group")
                        .WithMany("Bridges")
            ...
            modelBuilder.Entity("Interception.UI.Domain.TopologySnapshotBridgeAction", b =>
                {
                    b.HasOne("Interception.UI.Domain.TopologySnapshotBridge", "Bridge")
                        .WithMany("Actions")
