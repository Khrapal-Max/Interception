...
namespace Interception.UI.Migrations
{
    ...
    [Migration("20260411163920_UpProject")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.CanonicalPerson", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.CanonicalPersonMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.DailyReport", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.InterceptionAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.InterceptionMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.InterceptionMessageLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.InterceptionMessageParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.MessageGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.ParticipantCandidateGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.ParticipantMatrix", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.ParticipantRole", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
                    ...
                    b.ToTable("participant_roles", (string)null);
                });

            modelBuilder.Entity("Interception.UI.Domain.Entities.PersonDirectiveRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.ResolvedParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotBridge", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotBridgeAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotGroupAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotGroupFrequency", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotGroupMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotRun", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.CanonicalPersonMember", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.CanonicalPerson", "CanonicalPerson")
                        .WithMany("Members")
                        .HasForeignKey("CanonicalPersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Interception.UI.Domain.Entities.ResolvedParticipant", "ResolvedParticipant")
                        .WithMany()
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.InterceptionMessage", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.InterceptionAction", "InterceptionAction")
                        .WithMany()
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.InterceptionMessageLabel", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.InterceptionMessage", null)
                        .WithMany("Labels")
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.InterceptionMessageParticipant", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.InterceptionMessage", "InterceptionMessage")
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.MessageGroup", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.DailyReport", "DailyReport")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.ParticipantCandidateGroup", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.ResolvedParticipant", null)
                        .WithMany()
                        .HasForeignKey("ResolvedParticipantId")
                    ...
                    b.OwnsOne("Interception.UI.Domain.ValueObjects.PatternMatchReasons", "Reasons", b1 =>
                        {
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.ParticipantMatrix", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.DailyReport", "DailyReport")
                        .WithOne("Matrix")
                        .HasForeignKey("Interception.UI.Domain.Entities.ParticipantMatrix", "DailyReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.PersonDirectiveRelation", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.CanonicalPerson", "FromCanonicalPerson")
                        .WithMany()
                        .HasForeignKey("FromCanonicalPersonId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Interception.UI.Domain.Entities.ResolvedParticipant", "FromResolvedParticipant")
                        .WithMany()
                        .HasForeignKey("FromResolvedParticipantId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Interception.UI.Domain.Entities.CanonicalPerson", "ToCanonicalPerson")
                        .WithMany()
                        .HasForeignKey("ToCanonicalPersonId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Interception.UI.Domain.Entities.ResolvedParticipant", "ToResolvedParticipant")
                        .WithMany()
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotBridge", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.TopologySnapshotGroup", "Group")
                        .WithMany("Bridges")
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotBridgeAction", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.TopologySnapshotBridge", "Bridge")
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("Interception.UI.Domain.Entities.TopologySnapshotGroup", b =>
                {
                    b.HasOne("Interception.UI.Domain.Entities.TopologySnapshotRun", "Run")
                        .WithMany("Groups")
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
