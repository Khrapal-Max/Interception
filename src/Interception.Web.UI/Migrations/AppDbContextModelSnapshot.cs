...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Interception.Domain.DailyReport", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.InterceptionAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.InterceptionMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.InterceptionMessageLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.InterceptionMessageParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.MessageGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.ParticipantCandidateGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.ParticipantMatrix", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.ResolvedParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.InterceptionMessage", b =>
                {
                    b.HasOne("Interception.Domain.InterceptionAction", "InterceptionAction")
                        .WithMany()
            ...
            modelBuilder.Entity("Interception.Domain.InterceptionMessageLabel", b =>
                {
                    b.HasOne("Interception.Domain.InterceptionMessage", null)
                        .WithMany("Labels")
            ...
            modelBuilder.Entity("Interception.Domain.InterceptionMessageParticipant", b =>
                {
                    b.HasOne("Interception.Domain.InterceptionMessage", "InterceptionMessage")
            ...
            modelBuilder.Entity("Interception.Domain.MessageGroup", b =>
                {
                    b.HasOne("Interception.Domain.DailyReport", "DailyReport")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("Interception.Domain.ParticipantCandidateGroup", b =>
                {
                    b.HasOne("Interception.Domain.ResolvedParticipant", null)
                        .WithMany()
                    ...
                    b.OwnsOne("Interception.Domain.PatternMatchReasons", "Reasons", b1 =>
                        {
            ...
            modelBuilder.Entity("Interception.Domain.ParticipantMatrix", b =>
                {
                    b.HasOne("Interception.Domain.DailyReport", "DailyReport")
                        .WithOne("Matrix")
                        .HasForeignKey("Interception.Domain.ParticipantMatrix", "DailyReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
