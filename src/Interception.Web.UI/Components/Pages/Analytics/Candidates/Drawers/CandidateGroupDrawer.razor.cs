...
public partial class CandidateGroupDrawer : ComponentBase
{
    ...
    protected override async Task OnParametersSetAsync()
    {
        ...
        _confirmName = StringSemanticValueExtensions.NormalizeMeaningfulOrNull(Group?.SuggestedName) ?? string.Empty;
        _confirmRole = StringSemanticValueExtensions.NormalizeMeaningfulOrNull(Group?.SuggestedRole) ?? string.Empty;
        _confirmDivision = StringSemanticValueExtensions.NormalizeMeaningfulOrNull(Group?.SuggestedDivision) ?? string.Empty;
        _nameError = false;
        _serverError = null;
        _suggestions = [];
        _contextSuggestions = [];
    ...
    {
        _confirmName = StringSemanticValueExtensions.NormalizeMeaningfulOrNull(suggestion.Name) ?? string.Empty;
        _confirmRole = StringSemanticValueExtensions.NormalizeMeaningfulOrNull(suggestion.Role) ?? string.Empty;
        _confirmDivision = StringSemanticValueExtensions.NormalizeMeaningfulOrNull(suggestion.Division) ?? _confirmDivision ?? string.Empty;
        _nameError = false;
    }
    ...
    {
        _confirmDivision = StringSemanticValueExtensions.NormalizeMeaningfulOrNull(suggestion.Division) ?? string.Empty;
    }
    ...
    private static string NormalizeKey(string? value)
        => StringSemanticValueExtensions.NormalizeKeyOrNull(value) ?? string.Empty;
