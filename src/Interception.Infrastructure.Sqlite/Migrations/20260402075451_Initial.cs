...
namespace Interception.Infrastructure.Sqlite.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    group_key = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_participant_candidate_group_refs_candidate_group_id_participant_id",
