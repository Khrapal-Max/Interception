...
namespace Interception.Infrastructure.Sqlite.Migrations
{
    ...
    [Migration("20260402075451_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Interception.Domain.Entities.DailyReport", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.Entities.InterceptionAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.Entities.InterceptionMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.Entities.InterceptionMessageLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.Entities.InterceptionMessageParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.Entities.MessageGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.Entities.ParticipantCandidateGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.Entities.ParticipantMatrix", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.Entities.ResolvedParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Interception.Domain.Entities.InterceptionMessage", b =>
                {
                    b.HasOne("Interception.Domain.Entities.InterceptionAction", "InterceptionAction")
                        .WithMany()
            ...
            modelBuilder.Entity("Interception.Domain.Entities.InterceptionMessageLabel", b =>
                {
                    b.HasOne("Interception.Domain.Entities.InterceptionMessage", null)
                        .WithMany("Labels")
            ...
            modelBuilder.Entity("Interception.Domain.Entities.InterceptionMessageParticipant", b =>
                {
                    b.HasOne("Interception.Domain.Entities.InterceptionMessage", "InterceptionMessage")
            ...
            modelBuilder.Entity("Interception.Domain.Entities.MessageGroup", b =>
                {
                    b.HasOne("Interception.Domain.Entities.DailyReport", "DailyReport")
                        .WithMany("Groups")
                        .HasForeignKey("DailyReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("Interception.Domain.Records.MessageGroupEntry", "Entries", b1 =>
                        {
            ...
            modelBuilder.Entity("Interception.Domain.Entities.ParticipantCandidateGroup", b =>
                {
                    b.HasOne("Interception.Domain.Entities.ResolvedParticipant", null)
                        .WithMany()
                        .HasForeignKey("ResolvedParticipantId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.OwnsMany("Interception.Domain.Records.ParticipantRef", "ParticipantRefs", b1 =>
                        {
                            b1.Property<int>("id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("INTEGER")
                    ...
                    b.OwnsOne("Interception.Domain.Entities.PatternMatchReasons", "Reasons", b1 =>
                        {
            ...
            modelBuilder.Entity("Interception.Domain.Entities.ParticipantMatrix", b =>
                {
                    b.HasOne("Interception.Domain.Entities.DailyReport", "DailyReport")
                        .WithOne("Matrix")
                        .HasForeignKey("Interception.Domain.Entities.ParticipantMatrix", "DailyReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("Interception.Domain.Records.MatrixCell", "Cells", b1 =>
                        {
